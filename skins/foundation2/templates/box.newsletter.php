...
<div id="box-newsletter">
   <h3 class="hide">{$LANG.newsletter.mailing_list}</h3>
   {if $IS_USER}
   {if ($CTRL_SUBSCRIBED)}
   ...
   <form action="{$VAL_SELF}" method="post" id="newsletter_form_box">
      ...
      <div class="row collapse">
         <div class="small-8 columns"><input name="subscribe" id="newsletter_email" type="text" size="18" maxlength="250" title="{$LANG.newsletter.subscribe}" placeholder="{$LANG.newsletter.mailing_list}"/></div>
